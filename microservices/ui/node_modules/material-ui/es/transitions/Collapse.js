  ...
  render() {
    const _props = this.props,
      ...
      timeout
          ...
          other = _objectWithoutProperties(_props, ['appear', 'children', 'classes', 'className', 'collapsedHeight', 'component', 'onEnter', 'onEntered', 'onEntering', 'onExit', 'onExiting', 'style', 'theme', 'timeout']);
